    ...
    return(
        <tr className='border-b hover:bg-gray-100'>
            ...
            <td className='p-3'>
                ...
                <p><span className='text-gray-700 uppercase font-bold'>Telefono: </span>{telefono}</p>
            </td>
            <td className='p-3'>{empresa}</td>
            <td className='p-3'>
                <button
                    type='button'
                    className='bg-green-600 hover:bg-green-700 block w-full text-white p-2 uppercase font-bold text-xs mt-3'
